function [W, diff] = multiLayeredPerceptronWithSaturationControl(saturationControl, trainingSet, middleAmount, gName, maxIt, ETol, haveAdaptativeEta, a_etha, b_etha)
