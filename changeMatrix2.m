function [ firstLayer, secondLayer, thirdLayer ] = changeMatrix(E, h_1, V_1, W_2, h_2, V_2, W_3, h_3, o, S, gName)
...
g_2_prim = zeros(layerAmount_3,1);
for i = 1:layerAmount_2
    g_2_prim(i) = gDerivated(gName, h_2(i));
end

delta_2 = transpose(W_3(:,2:end))*delta_1.* g_2_prim;
secondLayer = delta_2*transpose(V_1);

g_1_prim = zeros(layerAmount_2,1);
for i = 1:layerAmount_3
