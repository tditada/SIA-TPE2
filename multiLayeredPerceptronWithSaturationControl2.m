function [W_1_best, W_2_best, diff] = multiLayeredPerceptronWithSaturationControl2(saturationControl, trainingSet, middleAmount, gName, maxIt, calcAllFreq, ETol)
            ...
            if (mod(i,20*trainingAmount) == 0)
               ...
               % disp(E_best);
                ...
                for j=1:size(training,1)
                    [h_1, V_1] = calculateLayer(W_1_best, transpose(training(j,:)), gName);
